...
function TaskForm() {
  ...
  return (
    <div className="flex w-full p-2 h-auto md:w-[600px]">
      <form
        className="bg-blue-50 bg-opacity-40 shadow-md rounded-md p-2 border-2 flex-col items-center gap-2 border-blue-100 w-full h-full overflow-auto"
        onSubmit={handleSubmit}
        ref={form}
      >
        {/* Título de la tarea */}
        <label htmlFor="title" className="block text-gray-700 text-sm font-bold mb-2 mt-2">
          Título de la Tarea
        </label>
        <input
          type="text"
        ...
        {/* Fecha de creación */}
        <label htmlFor="createdAt" className="block text-gray-700 text-sm font-bold mb-2 mt-2">
          Fecha de Creación
        </label>
        <input
          type="date"
        ...
        {/* Fecha de conclusión */}
        <label htmlFor="expeditionDate" className="block text-gray-700 text-sm font-bold mb-2 mt-2">
          Fecha de Conclusión
        </label>
        <input
          type="date"
          ...
          className="shadow appearance-none border rounded-lg w-full py-2 px-3 mb-3"
        />
        {errors.expeditionDate && <p className="text-red-500 text-sm mt-1">{errors.expeditionDate}</p>}

        {/* Prioridad */}
        <label htmlFor="priority" className="block text-gray-700 text-sm font-bold mb-2 mt-2">
          Prioridad
        </label>
        <select
          name="priority"
        ...
        {/* Botón de enviar */}
        <button
          className="bg-blue-700 bg-opacity-60 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-full"
        >
